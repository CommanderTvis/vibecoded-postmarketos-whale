...
**Function:** ships a one-glyph colour font holding *only* the whale and a fontconfig rule preferring it over Noto; all other emoji fall through unchanged. For the real Apple glyph (not the bundled placeholder doodle): `make font-apple APPLE="/path/Apple Color Emoji.ttc"`.
